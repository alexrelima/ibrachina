				...
				if ( $pagenow == 'themes.php' && $_GET['page'] == 'theme-settings' ){ 
					...
					switch ( $tab ){					
						...
						<tr>
							...
							<td>
								<input type="text" id="facebook" name="facebook" value="<?php echo esc_html( stripslashes( $settings["facebook"] ) ); ?>">
							</td>
						</tr>
						<tr>
							<th><label for="linkedin">LinkedIn:</label></th>
							<td>
								<input type="text" id="linkedin" name="linkedin" value="<?php echo esc_html( stripslashes( $settings["linkedin"] ) ); ?>">
							</td>
						</tr>
						<tr>
